...
bool CPlayerBase::SendMsgToClient(const google::protobuf::Message* msg, uint16_t msg_type, uint8_t compress, uint8_t encrypt)
{
	if (m_pSession)
	{
...
bool CPlayerBase::SendMsgToClient(const void* msg, uint16_t msg_len, uint16_t msg_type, uint8_t compress, uint8_t encrypt)
{
	if (m_pSession)
	{
