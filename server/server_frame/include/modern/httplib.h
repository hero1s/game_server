...
public:
    ...
    post(const char* path, const Headers& headers, const std::string& body, const char* content_type);
...
inline Server::Server(HttpVersion http_version)
        :http_version_(http_version), svr_sock_(-1)
{
#ifndef _WIN32
...
inline Client::Client(
        ...
        :host_(host), port_(port), timeout_sec_(timeout_sec), http_version_(http_version),
